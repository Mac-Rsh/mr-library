...
//<<< Using the decimal-mr_printf mode in the built-in mr_printf >>>
#define USING_MR_PRINTF_DEC         __CONFIG_ENABLE
//<<< Using the hexadecimal-mr_printf mode in the built-in mr_printf >>>
#define USING_MR_PRINTF_HEX         __CONFIG_ENABLE
//<<< Using the octal-mr_printf mode in the built-in mr_printf >>>
#define USING_MR_PRINTF_OCT         __CONFIG_ENABLE
//<<< Using the unsigned-mr_printf mode in the built-in mr_printf >>>
#define USING_MR_PRINTF_UNSIGNED    __CONFIG_ENABLE
//<<< Using the char-mr_printf mode in the built-in mr_printf >>>
#define USING_MR_PRINTF_CHAR        __CONFIG_ENABLE
//<<< Using the string-mr_printf mode in the built-in mr_printf >>>
#define USING_MR_PRINTF_STRING      __CONFIG_ENABLE
//<<< Using the float-mr_printf mode in the built-in mr_printf >>>
